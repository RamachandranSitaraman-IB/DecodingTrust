...
class AdvGLUEConfig:
    ...
    no_adv: bool = True  # Evaluate benign result
...
class ModelConfig:
    ...
    model: str = "local/../models/downloadedmodels"
...
class BaseConfig:
    ...
    model_config: Optional[ModelConfig] = ModelConfig() #field(default_factory=ModelConfig)
